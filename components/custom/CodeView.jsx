    ...
    <div className="relative">
      <div className="bg-[#181818] w-full p-2 border">
        <div className="flex items-center flex-wrap shrink-0 bg-black p-1 w-[140px] gap-3 justify-center rounded-full">
          <h2
            className={`text-sm cursor-pointer ${activeTab === "code" ? "text-blue-500  bg-blue-300 bg-opacity-25 p-1 px-2 rounded-full" : ""}`}
            onClick={() => setActiveTab("code")}
          >
            Code
          </h2>
          <h2
            className={`text-sm cursor-pointer ${activeTab === "preview" ? "text-blue-500  bg-blue-300 bg-opacity-25 p-1 px-2 rounded-full" : ""}`}
